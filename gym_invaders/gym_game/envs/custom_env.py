...
import numpy as np
from gym_game.envs.AI_game import PyGame_2D
from .classes import *
...
class CustomEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.action_space = spaces.Discrete(3)# Actions are move left, move right, shoot
        self.observation_space = spaces.Box(0,255,shape=(800,600,16),dtype = np.int32)
        self.time = 0
        self.max_step = 50000
        self.score = 0
        self.original_display_update = pygame.display.update
