...
class AIPVPScreen(LocalPVPScreen):
    ...
    def draw_letters(self) -> None:
        ...
        self.write_main(self.font, WHITE, f"AI Lives: {self.player2.get_lives()}", self.screen_width - 10, 10,
                        Direction.RIGHT)
        ...
        self.write_main(self.font, WHITE, f"Lives: {self.player1.get_lives()}", self.screen_width - 10,
                        self.screen_height - 20, Direction.RIGHT)
