...
from .. import CoopScreen, Player, AIPlayer, WHITE, Difficulty, Direction, State, AchievmentTracker
...
class AICoopScreen(CoopScreen):
    def __init__(self, screen_width: int, screen_height: int, screen, sensitivity: int, fps: int,
        ...
        super().__init__(screen_width, screen_height, screen, sensitivity, fps, difficulty, tracker, player_lives,
                         debug)
    ...
    def spawn_players(self) -> None:
        ...
        # Create the AI
        self.player2 = AIPlayer(self.sensitivity, self.screen_width, self.screen_height, self.screen_width // 3,
    ...
    def draw_letters(self) -> None:
        ...
        self.write_main(self.font, WHITE, f"AI Lives: {self.player2.get_lives()}", self.screen_width - 10, 30,
                        Direction.RIGHT)
