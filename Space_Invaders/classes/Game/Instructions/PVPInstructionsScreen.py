...
class PVPInstructionsScreen(MenuTemplate):
    ...
    def write_lines(self):
        ...
        self.write(self.end_font, WHITE, "AD to move Space to shoot", self.screen_width//2, first_px + self.screen_height // 15)
        self.write(self.end_font, WHITE, "Player 2:", self.screen_width//2, first_px + self.screen_height // 7.5)
        self.write(self.end_font, WHITE, "Arrowkeys to move 0 to shoot", self.screen_width//2, first_px + self.screen_height//5)
        self.write(self.end_font, WHITE, "P to pause and unpause", self.screen_width//2, first_px + self.screen_height//5 + self.screen_height // 15)
