...
class InstructionScreen(MenuTemplate):
    ...
    def write_lines(self):
        ...
        self.write(self.end_font, WHITE, "Press spacebar to shoot", self.screen_width // 2,
                   first_px + self.screen_height // 15)
        self.write(self.end_font, WHITE, "Press P to pause and unpause", self.screen_width // 2,
                   first_px + self.screen_height // 7.5)
        self.write(self.end_font, WHITE, "Press X to screenshot anytime", self.screen_width // 2,
