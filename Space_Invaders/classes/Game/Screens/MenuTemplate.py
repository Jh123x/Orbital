...
class MenuTemplate(Screen):
    ...
    def __init__(self, screen_width: int, screen_height: int, state: State, screen, curr_pointer: int = 0,
                 debug: bool = False):
    ...
    def refresh_pointer(self) -> None:
        ...
        self.pointer = ImageObject(pointed_obj.left - 40, pointed_obj.center[1], 40, 30,
                                   self.pointers[self.curr_pointer], self.debug)
