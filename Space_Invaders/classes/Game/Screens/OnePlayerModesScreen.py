...
class OnePlayerModeScreen(MenuTemplate):
    ...
    def write_lines(self) -> None:
        ...
        self.buttons.append(self.write(self.end_font, WHITE, "Story Mode", self.screen_width//2, self.screen_height//2))

        #Draw the rectangles for the classic button
        self.buttons.append(self.write(self.end_font, WHITE, "Classic Mode", self.screen_width//2, self.screen_height//15 + self.screen_height//2))

        #Draw the rectangles for the endless button
        self.buttons.append(self.write(self.end_font, WHITE, "Endless Mode", self.screen_width//2, self.screen_height//7.5 + self.screen_height//2))

        #Draw the online button
        self.buttons.append(self.write(self.end_font, WHITE, "Online Mode", self.screen_width//2, self.screen_height//5 + self.screen_height//2))
