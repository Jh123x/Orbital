...
class PlayModeScreen(MenuTemplate):
    ...
    def write_lines(self) -> None:
        ...
        #Rect for tutorial
        self.tutorial = self.write(self.end_font, WHITE, "Tutorial", self.screen_width//2, first_pixel + self.screen_height//5)

        #Rect for AI modes
        self.ai_modes = self.write(self.end_font, WHITE, "AI Modes", self.screen_width //2, first_pixel + self.screen_height//7.5)
        ...
        self.two_player = self.write(self.end_font, WHITE, "2 Player Modes", self.screen_width//2, first_pixel + self.screen_height//15)
