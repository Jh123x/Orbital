...
class OnlinePVPScreen(LocalPVPScreen):
    ...
    def shoot_bullet(self, enemy):
        ...
        if enemy:
            ...
            self.mob_bullet.add(Bullet(self.sensitivity, x_coord, self.screen_height // 2, direction, self.screen_width,
                                       self.screen_height, self.debug))
    ...
    def handle(self) -> State:
        ...
        if self.waiting:
            ...
            self.back_rect = self.write_main(self.end_font, WHITE, f"Back", self.screen_width // 2,
