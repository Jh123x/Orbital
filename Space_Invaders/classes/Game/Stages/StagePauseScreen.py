...
class StagePauseScreen(PauseScreen):
    ...
    def __init__(self, screen_width: int, screen_height: int, screen, stage: int, previous_state: State,
                 debug: bool = False):
    ...
    def write_lines(self) -> None:
        ...
        self.write(self.subtitle_font, WHITE, f"Stage {self.get_stage()}", self.screen_width // 2,
