...
class StageGameoverScreen(GameoverScreen):
    ...
    def __init__(self, screen_width: int, screen_height: int, screen, stage: int, prev_state: State,
                 debug: bool = False):
    ...
    def write_score(self):
        ...
        self.write(self.end_font, WHITE, "Mission failed", self.screen_width // 2,
