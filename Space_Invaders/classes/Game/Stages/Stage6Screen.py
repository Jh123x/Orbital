...
class Stage6Screen(StoryTemplate):
    ...
    def __init__(self, screen_width: int, screen_height: int, screen, sensitivity: int, max_fps: int,
        ...
        self.s_net = AIPlayer(self.sensitivity, self.screen_width, self.screen_height, self.screen_width // 2, 50, 5,
                              self.fps, self.mob_bullet, Direction.DOWN, 5, ai_avail=True, boss=True, debug=self.debug)
        ...
        # Image of Cloud-net
        self.terminator = ImageObject(self.screen_width // 2, int(self.screen_height * 210 / 800), 217, 217,
                                      StoryTemplate.sprites_dict['terminator'], debug)
        ...
        self.shadow = ImageObject(self.screen_width // 2, int(self.screen_height * 210 / 800), 217, 217,
