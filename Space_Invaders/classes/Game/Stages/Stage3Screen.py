...
from .. import State, ImageObject, Direction, WHITE, Scout, AchievmentTracker
...
class Stage3Screen(StoryTemplate):
    ...
    def __init__(self, screen_width: int, screen_height: int, screen, sensitivity: int, max_fps: int,
        ...
        self.marco = ImageObject(self.screen_width // 2, int(self.screen_height * 210 / 800), 217, 217,
                                 StoryTemplate.sprites_dict['yuckerberg'], debug)
    ...
    def _spawn_scout(self, x, y):
        ...
        self.other_enemies.add(
            Scout(self.sensitivity, x, y, 1, self.screen_width, self.screen_height, self.mob_bullet, self.debug))
