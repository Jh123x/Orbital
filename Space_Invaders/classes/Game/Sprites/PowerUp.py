...
def shield_up(screen, player):
    ...
    # Spawn the blocks
    screen.blocks = BlockGroup(screen.screen_width, screen.screen_height, screen.screen_width,
                               screen.screen_height // 1.2, screen.screen, 3, screen.player1.get_height() + 10)
...
class PowerUp(ImageObject):
    ...
    def __init__(self, initial_x: int, initial_y: int, width: int, height: int, power_type: str, time_to_live: int,
                 debug: bool = False):
