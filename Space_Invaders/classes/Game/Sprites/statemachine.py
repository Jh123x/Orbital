...
class StateMachine:
    ...
    def balanced(self, entities):
        ...
        if (nearest_mob_loc < 400 or nearest_boss_loc < 500 or entities['enemy_player'] != 'None') and rand < (
                0.85 - 0.05 * self.difficulty):
